<template>
    <div class="modal modal-bottom sm:modal-middle" :class="{'modal-open': modal.edit}">
        <div class="modal-box bg-base-200 text-base-content">
            ...
            <form method="post" @submit.prevent="editExpense">
                ...
                <div class="mb-4 form-group">
                    ...
                    <select id="method" class="select w-full" v-model="expense.method_id">
                        ...
                        <option
                            ...
                            :key="idx"
                            :value="method.id"
                            :selected="method.id === expense.method_id"
                        >
                            {{ method.name }}
                        </option>
                    </select>
...
export default {
    ...
    setup() {
        const {errors, message, expense, updateExpense, getExpenses, clearMessages} = useExpense();
